...
basket.addProduct();
//---------------------------------------------------------------------------
//первое задание к 4 уроку
const blockText = document.querySelector('.block-text');
const text = blockText.querySelector('.text');
let textResult_1 = text.innerText.replace(/'/g, '"');
blockText.innerHTML = textResult_1;
//-------------------------------
//2 задание к 4 уроку

const blockResult = document.querySelector('.block-result');
result2 = textResult_1.replace(/\b"\b/g, "'");

blockResult.innerHTML = result2;